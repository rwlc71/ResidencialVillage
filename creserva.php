...
if ($ln['dt_entrada_efetiva'] !== null && $ln['dt_entrada_efetiva'] !== '0000-00-00 00:00:00') {
    $dataEntradaEfetiva = date('d/m/Y', strtotime($ln['dt_entrada_efetiva']));
    $horaEntradafetiva = date('H:i', strtotime($ln['dt_entrada_efetiva']));
}

if ($ln['dt_saida_efetiva'] !== null && $ln['dt_saida_efetiva'] !== '0000-00-00 00:00:00' ) {
