...
//    echo("Resposta: " . $r . '<p>');
    ...
    if (json_last_error() === JSON_ERROR_NONE) {
        ...
        echo "Erro ao decodificar JSON: " . json_last_error_msg() . '<p>';
    }
    echo "Erro ao decodificar JSON: " . json_last_error_msg() . '<p>';

//    echo("Resposta: " . $r['status'] . '<p>');
//    echo("Resposta: " . $r['message'] . '<p>');
//    exit();
...
<div id="conteudo">
    ...
    <div id="cont">
        ...
        <br>
        <hr>
        <form method="post" action="consulta_entradas.php" enctype="multipart/form-data">
            <br>
...
<!--                <tr>
                ...
                <tr>
                    ...
                    <th width="25%" align="left" scope="col"><input type="text" value="<?= $lnEntrada['identificacao'] ?>" name="identificacao" size="60" /></th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <th width="25%" align="left" scope="col"><input type="text" name="contato" value="<?= $lnEntrada['contato'] ?>" size="25" maxlength="25"  /></th>
            ...
            <br>
            <center> <input type="submit" value="Pesquisar" name="filtro" value="pesquisar"/>
<!--                <input type="submit" value="Gravar" name="filtro" value="gravar"/>-->
            </center>
            <br />
            <script>
            ...
            <hr><br>
            <h3>Relatorio dos 20 últimos registros de entradas registradas</h3>
            Utilize a pesquisa para encontrar dados procurados.
            <div class="estiloTabelas table-responsive">
                <table width="100%" border="2" border-collapse: collapse;>
                    <tr>
                        <td width="15%" align="center" bgcolor="#191970"><font size="2"; color="#F5FFFA"><b> Anotado por </b></td>
                        <td width="15%" align="center" bgcolor="#191970"><font size="2"; color="#F5FFFA"><b> Nome </b></td>
...
//==========================================
                    ...
                    $sql = "SELECT *FROM entradas order by dthora_entrada desc LIMIT 20 ";

                    if (sizeof($where)) {
                        $sql = "SELECT * FROM entradas  ";
                        $sql .= ' WHERE ' . implode(' AND ', $where);
                        $sql = $sql . " ORDER BY dthora_entrada desc";
                    }
...
//==========================================                    
                    while ($ln = mysql_fetch_array($filtro)) {
                        ...
                        ?>
                        <tr>
                            <td align="left"><font size="2"; color="#000000"><?= strtoupper($ln['autor']) ?></td>
