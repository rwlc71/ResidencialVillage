...
<!--            <tr>
        ...
        <div class="estiloTabelas">
            <form id="formHospedes" method="POST" enctype="multipart/form-data">
                <table width="100%" border="1">
                    <tr>
                        <td width="50%" align="center" bgcolor="#191970">
                            <b><span style="color:#F5FFFA; font-size:14px;">Nome do Hóspede</span></b>
                        </td>
                        <td width="25%" align="center" bgcolor="#191970">
                            <b><span style="color:#F5FFFA; font-size:14px;">Nº CPF/RG</span></b>
                            <input type="hidden" name="id_locacao" value="<?= $id_locacao ?>" />
                        </td>
                        <td width="25%" align="center" bgcolor="#191970">
                            <b><span style="color:#F5FFFA; font-size:14px;">Parentesco</span></b>
                        </td>
                        <?php
        ...
        <script>
            function adicionarHospede() {
                ...
                cell3.innerHTML = '<input type="text" name="hospedes[parentesco][]" placeholder="Parentesco" size="20" maxlength="13" required>'; 
            }
