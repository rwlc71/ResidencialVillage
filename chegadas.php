...
<div id="conteudo">
    <div id="cont">
        <body>
            <h2>Relatorio de Chegadas</h2> <br>
            <hr />
            <form method="post" action="chegadas.php">
                <br>
            ...
            <div class="estiloTabelas table-responsive">
                <h3>Relatório de chegadas previstas</center></h3>
                <table  border="2">
                    <tr>
...
//                    $where[] = " uni.numero_etapa = '{$_POST['nr_etapa']}'";
                    ...
                    if (sizeof($where)) {
                        ...
                        $sql = $sql . " ORDER BY uni.etapa, uni.numero_etapa";
                    }
...
//                    echo(var_dump($ln));
                        ...
                        if ($ln['excluido_usuario'] == 'nao') {
                            $visualizarcomprovante = '<td align="center" valign="middle" bgcolor="#FFFFFA">' .
                                    ' <a href="creserva.php?dado=' . $ln['id_audita'] . '" title="Cadastrar ocorrência"> ' .
                                    '<img src="images/complementar.png"  title="Complementar Reserva" height=20 width=20 align="middle" border="0">' .
                                    '</td>';
                        }
                        ?>
                        <tr>
